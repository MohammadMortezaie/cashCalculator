...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ URL::to(env('APP_URL') . '/img/apple-touch-icon.png') }}">
    ...
    <link rel="manifest" href="{{ URL::to(env('APP_URL') . '/img/site.webmanifest') }}">
    <link rel="mask-icon" href="{{ URL::to(env('APP_URL') . '/img/safari-pinned-tab.svg') }}" color="#5bbad5">
